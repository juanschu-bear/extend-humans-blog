...
const articles = [
  ...
  { num: '08', slug: '/every-time-you-remember', title: { en: 'Every Time You Remember Something, You Change It.', de: 'Jedes Mal, wenn du dich erinnerst, ver\u00e4nderst du es.', es: 'Cada vez que recuerdas algo, lo cambias.' }, hook: { en: "Your memory doesn't store what happened. It stores what mattered.", de: 'Dein Ged\u00e4chtnis speichert nicht, was passiert ist. Es speichert, was z\u00e4hlte.', es: 'Tu memoria no guarda lo que pas\u00f3. Guarda lo que import\u00f3.' }, accent: '#FB7185', series: { en: 'Memory Series · Part 1', de: 'Ged\u00e4chtnis-Serie · Teil 1', es: 'Serie de Memoria · Parte 1' } },
  { num: '09', slug: '/your-avatar-remembers-you-better', title: { en: 'Your Avatar Remembers You Better Than Your Brain Does.', de: 'Dein Avatar erinnert sich besser an dich als dein Gehirn.', es: 'Tu avatar te recuerda mejor que tu cerebro.' }, hook: { en: 'Everyone who knows you either leaks you or forgets you.', de: 'Jeder, der dich kennt, verr\u00e4t dich oder vergisst dich.', es: 'Todos los que te conocen o te delatan o te olvidan.' }, accent: '#D4956A', series: { en: 'Memory Series · Part 2', de: 'Ged\u00e4chtnis-Serie · Teil 2', es: 'Serie de Memoria · Parte 2' } },
];
